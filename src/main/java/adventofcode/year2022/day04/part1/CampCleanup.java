...
public class CampCleanup {
    public static void main(String[] args) {
        ...
        int numberOfRangesFullyContained = getNumberOfRangesFullyContained(pairs);
    ...
    public static int getNumberOfRangesFullyContained(List<Pair> pairs) {
        int numberOfRangesFullyContained = 0;

        for (Pair pair : pairs) {
            if (pair.doesRangeContainOther()) {
